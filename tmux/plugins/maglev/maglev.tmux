...
apply_theme() {
    ...
    status_right="︎#[fg=$host_bg]$right_separator_black#[fg=$time_date_fg,bg=$host_bg,nobold] %R $right_separator %a %d %b  $right_separator "
#[fg=$host_bg]$right_separator_black#[fg=$host_fg,bg=$host_bg,bold]
